	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			try {
				...
				String input = sc.nextLine().trim();	// 앞뒤공백 제거
				
				if(input.equals("")) {	// space enter처리 : 다시 입력
					continue;
				}
					...
					System.out.println("history - 최근 입력한 명령어를 " + MAX_SIZE + "개 보여준다.");
				}
				else if(input.equals("history")) {
					int i = 0;
					save("history");	// queue에 기록
