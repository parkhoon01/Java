...
//		/Users/baghun/Desktop/DCOM_20220127/01_JAVA/workspace/J20/src
//		/Users/baghun/Desktop/DCOM_20220127/01_JAVA/workspace/J21/src/com/pcwk/ex01/file/FileEx01.java
		String path = "";
//		args.lenght 1개가 아니면 프로그램 종료
		if (args.length != 1) {
...
//		System.out.println("" + args[0]);
		...
		System.out.println("총 디렉토리수 : " + totalDirs);
		System.out.println("------------------------------");
	...
	public static void printFileList(File dir) {
		...
		int dirNum = subDir.size();	// subDir 
		// files.length = 파일과 디렉토리
